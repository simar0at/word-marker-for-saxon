 ...
 * @since   1.5
 */
public final class ScannerWithDelimiterAccess implements Iterator<String> {
    ...
    private Pattern integerPattern() {
        return integerPattern = Pattern.compile(buildIntegerPatternString());
    }
     ...
     */
    public ScannerWithDelimiterAccess(File source)
     ...
     * @return this scanner
     */
    public ScannerWithDelimiterAccess useDelimiter(String pattern) {
        delimPattern = Pattern.compile(pattern);
        return this;
    }
